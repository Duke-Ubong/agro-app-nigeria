...
export const AdminPortal: React.FC = () => {
  ...
  return (
    <div className={isSuperAdmin ? "" : "space-y-6"}>
      {!isSuperAdmin && (
        <>
            ...
            <div>
              <div className="flex flex-wrap items-center gap-2">
                <span className="bg-[#ba1a1a] text-white text-[10px] font-bold px-2.5 py-0.5 rounded-full uppercase tracking-wider shadow-xs">
                  {isGovAdmin ? 'Federal Ministry Director' : 'State ADP Admin'}
                </span>
      ...
      <div>
        {(activeTab === 'super_admin' || activeTab.startsWith('sa_')) && <SuperAdminDashboard />}
